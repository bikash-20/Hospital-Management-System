...
import { LabStatusPill, PrintModal } from '@/components/ui/primitives';
...
export default function Prescriptions() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      {!prescriptions || prescriptions.length === 0 ? (
        ...
        <div className="space-y-4">
          {prescriptions.map((rx) => (
            <div key={rx.id} className="card p-5 sm:p-6">
              {/* Header */}
      ...
      <PrintModal open={!!printingRx} onClose={() => setPrintingRx(null)} title="Prescription Preview">
        {printingRx && <PrintablePrescription prescription={printingRx} />}
      </PrintModal>
    </div>
  );
}